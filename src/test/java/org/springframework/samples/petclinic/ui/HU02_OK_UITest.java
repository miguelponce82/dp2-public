...
public class HU02_OK_UITest {
  ...
  @Test
  public void testHU02OK() throws Exception {
    ...
    driver.findElement(By.id("date")).sendKeys("2020/09/21");
    driver.findElement(By.id("time")).clear();
    driver.findElement(By.id("time")).sendKeys("11:00");
    ...
    driver.findElement(By.id("description")).sendKeys("Malo");
    driver.findElement(By.xpath("//button[@type='submit']")).click();
    assertEquals("2020-09-21", driver.findElement(By.xpath("//td[2]/table/tbody/tr/td")).getText());
  }
