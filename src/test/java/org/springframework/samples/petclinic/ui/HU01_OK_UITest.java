...
public class HU01_OK_UITest {
  ...
  @Test
  public void testHU01() throws Exception {
    ...
    driver.findElement(By.id("date")).sendKeys("2020/09/10");
    ...
    driver.findElement(By.xpath("//button[@type='submit']")).click();
    try {
      assertEquals("2020-09-10", driver.findElement(By.xpath("//td[2]/table/tbody/tr/td")).getText());
    } catch (Error e) {
