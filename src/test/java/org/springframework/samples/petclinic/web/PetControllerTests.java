...
class PetControllerTests {
	...
	private static final int TEST_OWNER_ID_TO_DELETE_SUCCESS = 3;
	
	private static final int TEST_PET_ID_TO_SUCCESS_DELETE = 4;
    ...
    //TESTS HECHOS EN TESTINTEGRATIONPETCONTROLLER
//    @WithMockUser(value = "spring")
//   	@Test
//   	void testProcessDeleteFormSuccess() throws Exception {
//		mockMvc.perform(get("/owners/{ownerId}/pets/{petId}/delete", 5, 6)
//							.with(csrf()))
//				.andExpect(status().is3xxRedirection())
//				.andExpect(view().name("redirect:/owners/{ownerId}"));
//	}
...
//							.with(csrf()))
//				.andExpect(status().is3xxRedirection())
//				.andExpect(view().name("redirect:/errorDelete"));
//	}
//    
