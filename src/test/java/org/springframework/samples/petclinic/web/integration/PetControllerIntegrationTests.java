...
class PetControllerIntegrationTests {
	...
	private static final int TEST_OWNER_ID_NO_PET_RESIDENCE_ACTIVE = 5;
	
	private static final int TEST_NO_RESIDENCE_ACTIVE_PET_ID = 6; 
	...
	void testProcessDeleteFormError() throws Exception {
		ModelMap model = new ModelMap();
		String view = petController.processDelete(TEST_OWNER_ID, TEST_PET_ID, model);
		assertEquals(view, "redirect:/errorDelete");
	}
	
	@Test
	void testProcessDeleteFormSuccess() throws Exception {
		ModelMap model = new ModelMap();
		String view = petController.processDelete(TEST_OWNER_ID_NO_PET_RESIDENCE_ACTIVE, TEST_NO_RESIDENCE_ACTIVE_PET_ID, model);
		assertEquals(view, "redirect:/owners/{ownerId}");
	}
